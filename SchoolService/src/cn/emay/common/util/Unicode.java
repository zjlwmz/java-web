...
public class Unicode {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String a = fromEncodedUnicode("\u4eac\u54c8\u9ad8\u901f\u65b9\u5411"
				.toCharArray(), 0, "\u4eac\u54c8\u9ad8\u901f\u65b9\u5411"
				.length());
		System.out.println(a);
		
		
		
		String str="result:\"{message=\u7528\u6237\u6D3B\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A, status=ERROR}\"";
		str=fromEncodedUnicode(str.toCharArray(),0,str.length());
